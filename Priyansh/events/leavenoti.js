...
(typeof data.customLeave == "undefined") ? msg = " {name} "▬𝙱𝚈𝙴 𝙱𝚈𝙴 𝙱𝙰𝙱𝚈 𝙼𝙸𝚂𝚂 𝚈𝙾𝚄 𝚂𝙾 𝙼𝚄𝙲𝙷 𝚄𝙼𝙼𝙼𝙼𝙰𝙷_🥺\n😭😭\n এডমিন তুমি কিভাবে পারলে {name} কে কিক মারতে' 'তাকে ফিরিয়ে আনো আমি তাকে ছাড়া বাচবো নাহ_ 😭\n\n[❤️‍🔥] 🖤"...Good {session} || {time}" : msg = data.customLeave;
